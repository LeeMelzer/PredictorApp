...
def add_predictions(input_data):
    ...
    st.write("Probability of being malicous: ", model.predict_proba(input_array_scaled)[0][1])
...
def main():
    ...
    with st.container():
        ...
        st.write("Please connect this app to your cytology lab to help diagnose breast cancer from your tissue sample. This app uses a machine learning model to predict whether a breast mass is benign or malignant based on the measurements it receives from your cytosis lab. You can also update the measurements by hand using the sliders in the sidebar.")
